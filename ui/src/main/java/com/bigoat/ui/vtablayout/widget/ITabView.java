...
public interface ITabView {
    ...
    class TabTitle {
        ...
        public int getSizeSelected() {
            return mBuilder.mSizeSelected;
        }

        public int getSizeNormal() {
            return mBuilder.mSizeNormal;
        }
        ...
        public static class Builder {
            ...
            public Builder setTextSize(int sizeSp) {
                mSizeSelected = sizeSp;
                mSizeNormal = sizeSp;
                return this;
            }

            public Builder setTextSize(int sizeSpSelected, int sizeSpNormal) {
                mSizeSelected = sizeSpSelected;
                mSizeNormal = sizeSpNormal;
                return this;
            }
