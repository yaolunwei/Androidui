package com.bigoat.ui.vtablayout;
...
import com.bigoat.ui.R;
import com.bigoat.ui.vtablayout.adapter.TabAdapter;
import com.bigoat.ui.vtablayout.util.DisplayUtil;
import com.bigoat.ui.vtablayout.util.TabFragmentManager;
import com.bigoat.ui.vtablayout.widget.QTabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    private long animationDuratio = 100;
    ...
    private void addTabWithMode(TabView tabView) {
        ...
        if (tabView.getDividerView() != null) {
            tabView.addView(tabView.getDividerView());
        }
...
//    }
        ...
        if (adapter != null) {
            ...
            for (int i = 0; i < adapter.getCount(); i++) {
                addTab(new QTabView(mContext).setIcon(adapter.getIcon(i))
                        ...
                        .setDivider(adapter.getDividerView(i))
    ...
    public void setupWithList(@Nullable ViewPager viewPager) {
        if (mViewPager != null && mTabPageChangeListener != null) {
            mViewPager.removeOnPageChangeListener(mTabPageChangeListener);
        }
    ...
    public interface ScrollListener {
        ...
        void onTabLayout(VerticalTabLayout tabLayout);
    }

    public void setupWithScrollListener(final ScrollListener listener) {
        addOnTabSelectedListener(new OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabView tab, int position) {
            ...
            post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (direction > 0) {
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(animationDuratio);
                        ...
                        startAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(animationDuratio);
                        startAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                                mIndicatorTopY = Float.parseFloat(animation.getAnimatedValue().toString());
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorBottomY, targetBottom).setDuration(animationDuratio);
                        endAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                                mIndicatorBottomY = Float.parseFloat(animation.getAnimatedValue().toString());
